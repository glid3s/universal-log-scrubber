...
This project handles security-sensitive workflows. The most important contribution rule is: **do not include real secrets, raw client logs, salts, token maps, or local-only reports in issues, pull requests, examples, tests, screenshots, or documentation.**
...
- Improve false-positive handling for public diagnostics.
...
Do not use real organization names, real tenant IDs, real access keys, real usernames, real URLs from private environments, or real security event exports.
...
- Keep PowerShell compatible with PowerShell 5.1+ and PowerShell 7 where possible.
